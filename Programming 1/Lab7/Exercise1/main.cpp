...
std::cin>>value;
outcount=count(array,x2,value);//8
...
std::cout<<"Min value in array: "<<min(array,x2)<<std::endl;
std::cout<<"Max value in array: "<<max(array,x2)<<std::endl;
reverse(array,x2);//
std::cout<<"The order is reversed\n";
printArray(array,x2);//8
delete[]array;//8
return(0);
}
