...
bool DoublyLinkedList::contains(LeftistNode* elem){
	if(find(elem)==-1){
		return false;
	}
	else{
...
LeftistNode* DoublyLinkedList::peek(){
...
void DoublyLinkedList::addBack(LeftistNode* elem){
...
void DoublyLinkedList::push(LeftistNode* elem){
	add(elem, 0);
}
void DoublyLinkedList::add(LeftistNode* elem, int position) {
...
void DoublyLinkedList::deleteAll(LeftistNode* elem) {
...
int DoublyLinkedList::find(LeftistNode* elem) {
