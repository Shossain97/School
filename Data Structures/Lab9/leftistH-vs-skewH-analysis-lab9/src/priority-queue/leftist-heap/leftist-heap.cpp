...
void LeftistHeap::swapper(Node* subTreePtr){
...
void LeftistHeap::concatenateHelper(Node* parent, Node* subTreePtr, Node* leftover){
...
void LeftistHeap::addHelper(Node* parentNode, Node* subTreePtr, Node* newNode){
...
void LeftistHeap::deleteHelper(Node* aNode){
	if(aNode!=nullptr){
...
Task* LeftistHeap::deleteMinElem(){
  ...
  //or left concat with right
	...
	LeftistHeap* newpq=new LeftistHeap();
	Node* temp=root;
	Task* anItem;
...
int LeftistHeap::inorderTraversal(int identity, int (*op)(Task*)){
  
  return inorder(root, identity, op);
}
int LeftistHeap::inorder(Node* subTreePtr, int identity, int (*op)(Task*)){
...
int LeftistHeap::postorderTraversal(int identity, int (*op)(Task*)){
  
  return postOrder(root, identity, op);
}

int LeftistHeap::postOrder(Node* subTreePtr,int identity, int (*op) (Task*)){
		if(subTreePtr->getLeft()!=nullptr)
	{
