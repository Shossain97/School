...
;* Date/Time created: Wed Feb 01 15:50:01 2017                                *
;******************************************************************************
...
$C$DW$22	.dwtag  DW_TAG_variable
	...
	.data
	.align	4
	.elfsym	Task_Speakerbuzz_NextSwitch,SYM_SIZE(4)
Task_Speakerbuzz_NextSwitch:
	.bits	0,32			; Task_Speakerbuzz_NextSwitch @ 0

$C$DW$23	.dwtag  DW_TAG_variable
	.dwattr $C$DW$23, DW_AT_name("Task_Speakerbuzz_NextSwitch")
	.dwattr $C$DW$23, DW_AT_TI_symbol_name("Task_Speakerbuzz_NextSwitch")
	.dwattr $C$DW$23, DW_AT_type(*$C$DW$T$47)
	.dwattr $C$DW$23, DW_AT_location[DW_OP_addr Task_Speakerbuzz_NextSwitch]
...
;	C:\TI_CodeComposer\ccsv6\tools\compiler\ti-cgt-arm_15.12.1.LTS\bin\armacpia.exe -@C:\\Users\\SHOSSA~1\\AppData\\Local\\Temp\\1292812 
	.sect	".text"
	.clink
...
$C$DW$24	.dwtag  DW_TAG_subprogram
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 39,column 32,is_stmt,address Task_Speakerbuzz,isa 1
...
$C$DW$25	.dwtag  DW_TAG_variable
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 41,column 28,is_stmt,isa 1
        MOVS      A1, #0                ; [DPU_3_PIPE] |41| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |41| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 43,column 2,is_stmt,isa 1
        LDR       A1, $C$CON1           ; [DPU_3_PIPE] |43| 
        LDRB      A1, [A1, #0]          ; [DPU_3_PIPE] |43| 
        CBNZ      A1, ||$C$L1||         ; [] 
...
$C$DW$27	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 49,column 4,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |49| 
        MOVS      A2, #3                ; [DPU_3_PIPE] |49| 
        MOVS      A3, #1                ; [DPU_3_PIPE] |49| 
        MOVS      A4, #8                ; [DPU_3_PIPE] |49| 
$C$DW$28	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$28, DW_AT_low_pc(0x00)
	.dwattr $C$DW$28, DW_AT_name("GPIOPadConfigSet")
	.dwattr $C$DW$28, DW_AT_TI_call

        BL        GPIOPadConfigSet      ; [DPU_3_PIPE] |49| 
        ; CALL OCCURS {GPIOPadConfigSet }  ; [] |49| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 55,column 4,is_stmt,isa 1
...
$C$DW$29	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 59,column 4,is_stmt,isa 1
        ...
        MOV       A3, #880              ; [DPU_3_PIPE] |59| 
        UDIV      A1, A1, A3            ; [DPU_3_PIPE] |59| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |59| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 60,column 4,is_stmt,isa 1
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 62,column 4,is_stmt,isa 1
...
||$C$L1||:    
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 69,column 2,is_stmt,isa 1
        ...
        LDR       A2, $C$CON7           ; [DPU_3_PIPE] |69| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |69| 
        LDR       A2, [A2, #0]          ; [DPU_3_PIPE] |69| 
        CMP       A1, A2                ; [DPU_3_PIPE] |69| 
        BHI       ||$C$L2||             ; [DPU_3_PIPE] |69| 
        ; BRANCHCC OCCURS {||$C$L2||}    ; [] |69| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 74,column 4,is_stmt,isa 1
...
$C$DW$30	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$30, DW_AT_TI_call
        ...
        BL        GPIOPinRead           ; [DPU_3_PIPE] |74| 
        ; CALL OCCURS {GPIOPinRead }     ; [] |74| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |74| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 75,column 4,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |75| 
        EOR       A1, A1, #3            ; [DPU_3_PIPE] |75| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |75| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 76,column 10,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |76| 
        LDRB      A3, [SP, #0]          ; [DPU_3_PIPE] |76| 
        MOVS      A2, #3                ; [DPU_3_PIPE] |76| 
$C$DW$31	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 82,column 10,is_stmt,isa 1
        LDR       A2, $C$CON7           ; [DPU_3_PIPE] |82| 
        LDR       A1, $C$CON4           ; [DPU_3_PIPE] |82| 
        LDR       A3, [A2, #0]          ; [DPU_3_PIPE] |82| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |82| 
        LDR       A2, $C$CON6           ; [DPU_3_PIPE] |82| 
        ADDS      A1, A1, A3            ; [DPU_3_PIPE] |82| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |82| 
;* --------------------------------------------------------------------------*
||$C$L2||:    
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 86,column 2,is_stmt,isa 1
        ...
        BHI       ||$C$L5||             ; [DPU_3_PIPE] |86| 
        ; BRANCHCC OCCURS {||$C$L5||}    ; [] |86| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 87,column 3,is_stmt,isa 1
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |87| 
        LDR       A2, $C$CON4           ; [DPU_3_PIPE] |87| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |87| 
        LDR       A2, [A2, #0]          ; [DPU_3_PIPE] |87| 
        MOV       A3, #880              ; [DPU_3_PIPE] |87| 
        UDIV      A1, A1, A3            ; [DPU_3_PIPE] |87| 
        CMP       A1, A2                ; [DPU_3_PIPE] |87| 
        BNE       ||$C$L3||             ; [DPU_3_PIPE] |87| 
        ; BRANCHCC OCCURS {||$C$L3||}    ; [] |87| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 89,column 4,is_stmt,isa 1
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |89| 
        LDR       A2, $C$CON4           ; [DPU_3_PIPE] |89| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |89| 
        MOV       A3, #1500             ; [DPU_3_PIPE] |89| 
        UDIV      A1, A1, A3            ; [DPU_3_PIPE] |89| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |89| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 90,column 3,is_stmt,isa 1
        B         ||$C$L4||             ; [DPU_3_PIPE] |90| 
        ; BRANCH OCCURS {||$C$L4||}      ; [] |90| 
;* --------------------------------------------------------------------------*
||$C$L3||:    
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 93,column 4,is_stmt,isa 1
        ...
        MOV       A3, #880              ; [DPU_3_PIPE] |93| 
        UDIV      A1, A1, A3            ; [DPU_3_PIPE] |93| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |93| 
;* --------------------------------------------------------------------------*
||$C$L4||:    
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 95,column 3,is_stmt,isa 1
        LDR       A2, $C$CON5           ; [DPU_3_PIPE] |95| 
        LDR       A1, $C$CON7           ; [DPU_3_PIPE] |95| 
        LDR       A4, [A2, #0]          ; [DPU_3_PIPE] |95| 
        LDR       A3, [A1, #0]          ; [DPU_3_PIPE] |95| 
        LDR       A2, $C$CON8           ; [DPU_3_PIPE] |95| 
        MOV       V1, #1000             ; [DPU_3_PIPE] |95| 
        MOV       A1, #750              ; [DPU_3_PIPE] |95| 
        MULS      A1, A1, A4            ; [DPU_3_PIPE] |95| 
        UDIV      A1, A1, V1            ; [DPU_3_PIPE] |95| 
        ADDS      A1, A1, A3            ; [DPU_3_PIPE] |95| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |95| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 98,column 2,is_stmt,isa 1
;* --------------------------------------------------------------------------*
||$C$L5||:    
$C$DW$32	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$24, DW_AT_TI_end_column(0x02)
	.dwendentry
	.dwendtag $C$DW$24
...
||$C$CON7||:	.bits	SysTickCount_Nbr,32
	.align	4
||$C$CON8||:	.bits	Task_Speakerbuzz_NextSwitch,32
;*****************************************************************************
